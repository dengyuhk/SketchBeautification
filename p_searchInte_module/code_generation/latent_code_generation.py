...
def embeding(opt):
    if opt.action == 'generating':
        phase='train'
        print('generating code for {}........................'.format(opt.cate))
    ...
    with torch.no_grad():
        for partId in range(len(opt.part_names)):
            ...
            print('processing {} of {}...............'.format(part_name,opt.cate))
            # data_pt_name = opt.root +'/'+ part_name + '_sketch.pt'
            data_pt_name = BASE_DIR+ 'data/sketch_out' + '/' + part_name + '_sketch.pt'
        ...
        predict_path = os.path.join('../../','part_retrieval', folder, '{}_{}_{}.pkl'.format(opt.cate, 'search', 'latent'))
